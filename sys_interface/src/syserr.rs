pub const NOERROR: isize = 0; //   "no error",
...
pub const EWOULDBLOCK: isize = -11; //    "Operation would block",
...
pub const EDEADLOCK: isize = -35; //    "Same as EDEADLK (Resource deadlock would occur)",
...
pub static SYSCALL_ERR_MSG: &[&str] = &[
    "NO ERROR",
...
pub fn errno(err: isize) -> usize {
    (-err) as usize
}

pub fn msg(err: isize) -> &'static str {
    SYSCALL_ERR_MSG[errno(err)]
}
